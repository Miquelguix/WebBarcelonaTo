...
<div class="flex flex-wrap justify-between font-sans">
	@foreach($items as $item)
@if(($loop->first) or ($items->count() == 2))
	
	<section class="flex flex-col p-3 rounded-l md:flex-row">
		<div class="relative z-10 w-full md:w-1/2 xl:w-5/12">
	...
	<!--1/3 col -->
	@else
	<section class="flex flex-col flex-grow flex-shrink w-full p-3 md:w-1/3">
